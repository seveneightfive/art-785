...
const artistTypes = [
    ...
    { name: 'Visual', icon: Palette },
    { name: 'Performance', icon: Drama },
    { name: 'Literature', icon: PenSquare },
];
...
const ArtistDirectory = () => {
    ...
    const genres = useMemo(() => {
        ...
        const bandGenres = artists
            .filter(artist => artist.type === 'Band' && artist.genre)
    ...
    const filteredArtists = useMemo(() => {
        ...
        return artists
            .filter(artist => {
                ...
                return artist.type === activeTypeFilter;
            })
            .filter(artist => {
        ...
        <>
            ...
            <div className="container mx-auto px-4 py-8 md:py-12">
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">Explore, discover, and follow your favorite artists.</p>
                </motion.div>
